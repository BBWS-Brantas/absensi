                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?= base_url('reset-password-pegawai/' . $data_pegawai->username) ?>" class="btn btn-link text-secondary">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-lock me-2 text-secondary" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
